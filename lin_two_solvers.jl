...
p = performance_profile(hcat([p[:, 1] for p in values(stats)]...),
                            ...
                            titlefont = tf, legendfont = f, guidefont = f, size = (800,800)) # Profile for #f
...
#                             titlefont = tf, legendfont = f, guidefont = f, size = (800,800)) # Profile for #g
#
...
#                             titlefont = tf, legendfont = f, guidefont = f, size = (800,800)) # Profile for #Hv
#
...
#                             titlefont = tf, legendfont = f, guidefont = f, size = (800,800)) # Profile for #f + #g + #Hv
#
